...
const locale = {
    "mailbox": {
        ...
        "delete": "Izbriši mapu",
        "empty": "Ovaj poštanski pretinac je prazan"
    },
    "message": {
        "labels": {
            "from": "Iz:",
    ...
    "actions": {
        "backToMailbox": "Natrag na poštanski sandučić",
        "reload": "Osvježiti",
        "select": "Odaberi",
        ...
        "markAsSpam": "Označi kao neželjenu",
    ...
    "dialogs": {
        ...
        "deleteMailbox": {
            ...
            "desc": "Oprez. Ova će akcija trajno izbrisati sve poruke u mapi",
            "accept": "Izbrisati",
            "cancel": "Otkazati"
        }
    },
    "myAccount": {
        "title": "Moj račun",
        "commonActions": {
            "title": "Uobičajene radnje",
            "updatePassword": "Ažurirajte lozinku",
